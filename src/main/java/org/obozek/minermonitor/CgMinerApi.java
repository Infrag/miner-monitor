...
public class CgMinerApi
{
    ...
    public static String process(String command, String _ip, String _port) throws Exception
    {
        InetAddress ip;
        int port;
        ...
        return process(command, ip, port);
    }

    public static String process(String cmd, InetAddress ip, int port) throws Exception
    {
...
//    }
    ...
    public static void main(String[] params) throws Exception
    {
        ...
        new CgMinerApi(command, ip, port);
    }
}